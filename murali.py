...
questions=[
           " Which batsman has most runs in ipl history?",
           " Which batsmen is also known mr 360?",
           " Who took most wickets in ipl 2023?",
           " Which team won the ipl finals in the inagural season?",
           " What is highest score of a player in IPL history?"
             ]

answers_choice=[
    ["warner","Sachin Tendulkar","raina","Virat Kohli"],
    ["Yuvraj Singh","abdevilliers","Dhoni","Pollard"],
    ["shami","malinga","siraj","Shane Warne"],
    ["RR","RCB","SRH","PBKS"],
    ["145","175","183","195"],
]
...
quiz.title('Quiz Game by murali')

quiz.config(bg='white')


labeltext = Label(quiz,text="IPL Quiz", font=("Times New Roman",70,"bold"),bg="white")
labeltext.pack(pady=(0,50))

image1 = PhotoImage(file="starts.png")
